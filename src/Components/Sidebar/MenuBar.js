...
const MenuBar = ({isOpen}) => {
  ...
  return (
    ...
    <>
    {
        <div className={`menu-bar-container display-none ${isOpen?"menu-bar-container-display":"menu-bar-container-hide"}`}>
      ...
      <div className='sidebar-nav'>
        <div 
           ...
           style={{backgroundColor:(isHovered===0 || selected===0)?"#353945":"transparent",width:"100%"}}
         >
           <img 
           ...
           />
           <p 
             style={{color:(isHovered===0 || selected===0)?"white":"grey"}}
           >
             Home
           </p>          
         </div>
         ...
         <div 
           ...
           style={{backgroundColor:(isHovered===1 || selected===1)?"#353945":"transparent",width:"100%"}}
         >
           <img 
           ...
           />
           <p 
             style={{color:(isHovered===1 || selected===1)?"white":"grey"}}
           >
             Section 1
           </p>          
         </div>
         <div 
           ...
           style={{backgroundColor:(isHovered===2 || selected===2)?"#353945":"transparent",width:"100%"}}
         >
           <img 
           ...
           />
           <p 
             style={{color:(isHovered===2 || selected===2)?"white":"grey"}}
           >
             Section 2
           </p>          
         </div>
         <div 
           ...
           style={{backgroundColor:(isHovered===3 || selected===3)?"#353945":"transparent",width:"100%"}}
         >
           <img 
           ...
           />
           <p 
             style={{color:(isHovered===3 || selected===3)?"white":"grey"}}
           >
             Section 3
           </p>          
         </div>
         <div 
           ...
           style={{backgroundColor:(isHovered===4 || selected===4)?"#353945":"transparent",width:"100%"}}
         >
           <img 
           ...
           />
           <p 
             style={{color:(isHovered===4 || selected===4)?"white":"grey"}}
           >
             Section 4
           </p>          
         </div>
